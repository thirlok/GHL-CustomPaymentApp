            ...
            if (subTyperes.data.statusdesc.subType === "upsell") {
              if (
                ...
                if (subTyperes.data.statusdesc.subType === "upsell") {
                  ...
                  //api call for upsell transaction
                  axios({
                    ...
                    .then((upsellTransactionRes) => {
                      ...
                      console.log(
                        "upsell transaction status code",
                        upsellTransactionRes.data.Capture.status.errorcode
                      );
                      if (
                        upsellTransactionRes.data.Capture.status.errorcode ==
                        "00"
                      ) {
                        console.log("Upsell transaction successful");
                    ...
                    .catch((err) => {
                      console.error(
                        "error while doing upsell transaction",
                        err
                      );
                    });
                }
