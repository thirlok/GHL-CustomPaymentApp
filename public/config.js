window.env = {
  ...
  DB_GETSUBTYPEUSINGORDERID:'https://us-central1-cert-dev-f6b62.cloudfunctions.net/ghl_getSubTypeUsingOrderId',
  DB_DOUPSELLTRANSACTION:'https://us-central1-cert-dev-f6b62.cloudfunctions.net/ghl_doUpsellTransaction'
};